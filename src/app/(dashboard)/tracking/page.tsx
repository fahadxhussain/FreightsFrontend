        ...
        <div className="p-6 overflow-y-auto scrollbar-hide">
          <div className="mb-8">
            ...
            <div className="flex items-center gap-4 p-4 rounded-2xl bg-card border border-border shadow-sm">
              ...
              <div>
                <div className="text-sm font-black text-foreground">Mike Thompson</div>
                <div className="text-[10px] font-bold text-muted uppercase tracking-widest">(555) 234-5678 · FB-2847</div>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-3">
              <div className="p-5 rounded-2xl bg-card border border-border hover:border-accent/30 transition-all cursor-pointer">
                <div className="flex justify-between items-center mb-3">
                  <div className="text-[11px] font-black text-foreground uppercase tracking-widest">Stop 1 — Pickup</div>
                  <span className="badge badge-amber px-2 h-5">Approaching</span>
                </div>
                <div className="flex items-start gap-2 mb-2">
                  <MapPin size={16} className="text-muted mt-0.5" />
                  <span className="text-xs font-bold text-muted-foreground leading-relaxed">1200 W 35th St, Chicago, IL</span>
                </div>
                <div className="flex items-center gap-2">
                  <Clock size={16} className="text-muted" />
                  <span className="text-[10px] font-black text-muted uppercase tracking-widest">Scheduled: Apr 2, 8:00 AM</span>
                </div>
              </div>

              <div className="p-5 rounded-2xl bg-card border border-border opacity-60 hover:opacity-100 transition-all cursor-pointer">
                <div className="flex justify-between items-center mb-3">
                  <div className="text-[11px] font-black text-foreground uppercase tracking-widest">Stop 2 — Delivery</div>
                  <span className="badge badge-gray px-2 h-5">Pending</span>
                </div>
                <div className="flex items-start gap-2 mb-2">
                  <MapPin size={16} className="text-muted mt-0.5" />
                  <span className="text-xs font-bold text-muted-foreground leading-relaxed">4500 Ross Ave, Dallas, TX</span>
                </div>
                <div className="flex items-center gap-2">
                  <Clock size={16} className="text-muted" />
                  <span className="text-[10px] font-black text-muted uppercase tracking-widest">Scheduled: Apr 4, 2:00 PM</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="flex-1 relative bg-card overflow-hidden">
        ...
        <div className="absolute top-6 left-6 right-6 z-10 flex items-center justify-between">
           <div className="flex items-center gap-4 p-4 rounded-2xl bg-card/80 backdrop-blur-md border border-border shadow-2xl">
              <div className="badge badge-blue h-7 px-3">FL-20042</div>
              <div className="flex items-center gap-3">
                 <span className="text-sm font-black text-foreground tracking-tight">Chicago, IL</span>
                 <ArrowRight size={14} weight="bold" className="text-muted" />
                 <span className="text-sm font-black text-foreground tracking-tight">Dallas, TX</span>
              </div>
              <span className="badge badge-amber h-7 px-3">In Transit</span>
           </div>
           <div className="flex items-center gap-3">
              <button 
        ...
        <div className="h-full w-full flex items-center justify-center bg-[#f0f2f5] dark:bg-[#0b0e14]">
           <div className="text-center animate-in zoom-in-95 duration-700">
              ...
              <p className="text-xs font-bold text-muted uppercase tracking-widest mb-6">Chicago → Springfield, MO → Dallas</p>
        ...
        <div className="absolute bottom-8 left-8 right-8 z-10 p-6 rounded-[2rem] bg-card/90 backdrop-blur-md border border-border shadow-2xl flex items-center justify-between">
           <div className="flex items-center gap-6">
              ...
              <div>
                 ...
                 <div className="text-lg font-black text-foreground tracking-tight">ETA to Dallas: 14h 20m</div>
              </div>
           </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-6 backdrop-blur-md bg-black/40 animate-in fade-in duration-300">
          <div className="w-full max-w-md rounded-3xl border border-border bg-card p-10 shadow-2xl animate-in zoom-in-95 duration-300">
            ...
            <div className="flex gap-2 mb-8">
              <input 
                readOnly
                value="https://flow.app/track/FL-20042-x8f2"
