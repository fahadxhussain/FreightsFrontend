  ...
  return (
    <div className="p-6 animate-in fade-in slide-in-from-bottom-4 duration-500 max-w-[1000px] mx-auto">
      ...
      {isLoading ? (
        ...
        <>
          {/* Summary */}
          <div className="rounded-2xl border border-hairline bg-card p-6 mb-8">
            <div className="grid grid-cols-[1fr_1fr] gap-8">
              <div className="flex items-center gap-6">
                <div className="text-center">
                  <div className="text-5xl font-semibold text-ink">{avgRating.toFixed(1)}</div>
          ...
          <div className="flex items-center gap-3 mb-6">
            <div className="relative flex-1">
              ...
              <input
                className="w-full rounded-xl border border-hairline bg-card pl-9 pr-3 py-2.5 text-xs font-medium outline-none focus:border-ink"
            ...
            <select
              className="h-10 rounded-xl border border-hairline bg-card px-3 text-xs font-bold text-ink outline-none cursor-pointer"
              value={ratingFilter ?? ''}
          ...
          <div className="space-y-4">
            {filteredReviews.length === 0 ? (
              ...
              filteredReviews.map((review) => (
                <div key={review._id} className="rounded-2xl border border-hairline bg-card p-5">
                  <div className="flex items-start justify-between mb-3">
                    <div className="flex items-center gap-3">
                      <div className="flex h-9 w-9 items-center justify-center rounded-full bg-primary text-[10px] font-semibold text-white">
                  ...
                  {review.comment && (
                    <p className="text-xs text-ink leading-relaxed mb-3">{review.comment}</p>
                  )}
                  ...
                  <button
                    className="flex items-center gap-1.5 text-[10px] font-bold text-ink mt-3 hover:underline"
